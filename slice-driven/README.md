...
| `/build` | Picks the next shaped item (or a named one) and burns down its tasks under strict TDD. Fills the item's Results section. | Passing code + tests, updated work item |
