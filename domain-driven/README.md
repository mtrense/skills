...
complexity: medium            # low | medium | high — reasoning difficulty of the pass, not volume (empty until refined; abstract, never a model name — the routing hint a later /task-cycle consumes)
