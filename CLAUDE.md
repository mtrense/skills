...
The common workflow ships three custom subagents under `common/agents/`, installed alongside skills by `install.sh`. The first two are used by `/spec-sharpener`, the third by `/version-bump`:
